    ...
    <div class="row no-gutters">
        <div class="col-md-4">
            <a href="{{ $link }}">
                ...
                src="{{ empty($post->featured_image) ? asset('images/article.png') : url($post->featured_image) }}"
                alt="{{ $post->title }}">
            </a>
        </div>
        <div class="col-md-8">
            <div class="card-body">
                ...
                <p class="card-text">
                    ...
                    <small class="text-muted">@lang('page.date.published'): {{ $post->publish_date->toDateString() }}</small>
                </p>
