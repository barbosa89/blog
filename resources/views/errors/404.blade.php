...
@section('content')
    <section class="error-signal flex min-h-screen items-center border-b border-rule-dark pb-16 pt-32 text-light">
        <div class="site-container grid gap-10 md:grid-cols-[minmax(0,0.75fr)_minmax(18rem,1.25fr)] md:items-center">
            ...
            <div>
                <p class="font-data text-xs uppercase tracking-[0.2em] text-track-yellow">@lang('page.technical.not_found')</p>
                <h1 class="mt-4 text-5xl text-light sm:text-7xl">@lang('page.404')</h1>
                <a class="signal-link signal-link--primary mt-8" href="{{ route('landing') }}">@lang('page.back_home')</a>
            </div>
        </div>
    </section>
