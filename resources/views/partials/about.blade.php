<section class="logbook-note border-y border-rule-dark py-18 sm:py-24" id="about">
    <div class="site-container grid gap-10 lg:grid-cols-[minmax(18rem,0.75fr)_minmax(0,1.25fr)] lg:gap-20">
        <div>
            <h2 class="section-heading text-light">{{ trans('page.landing.about_title') }}</h2>
            <p class="mt-6 max-w-lg text-lg leading-relaxed text-light-muted">{{ trans('page.landing.about_intro') }}</p>
        </div>

        <div class="border-t border-rule-dark pt-7">
            <p class="max-w-3xl text-lg leading-relaxed text-light">{{ trans('page.landing.about_body') }}</p>
            <p class="mt-5 max-w-3xl leading-relaxed text-light-muted">{{ trans('page.landing.about_detail') }}</p>
