...
keywords: 'phenix, web, framework, built, pure, php, external, extensions, based, amphp, ecosystem, -blocking, operations, asynchronism, parallel, code, execution, natively'
